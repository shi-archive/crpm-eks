...
export class Cluster extends cdk.Stack {
  constructor(scope: cdk.App, id: string, stackProps?: cdk.StackProps) {
    ...
    // VPC
    const vpcProps: crpm.Writeable<ec2.CfnVPCProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/vpc/props.yaml`
    );
    const vpc = new ec2.CfnVPC(this, "VPC", vpcProps);
    
    // Internet Gateway
    const igProps: crpm.Writeable<ec2.CfnVPCProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/internet-gateway/props.yaml`
    );
    const ig = new ec2.CfnInternetGateway(this, "InternetGateway", igProps);
    
    // Internet Gateway Attachment
    const igAttachmentProps: crpm.Writeable<ec2.CfnVPCGatewayAttachmentProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/vpc-gateway-attachment/props.yaml`
    );
    ...
    // Private Subnet 1A
    const privateSubnet1AProps: crpm.Writeable<ec2.CfnSubnetProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-private-1a/props.yaml`
    );
    ...
    // Private Subnet 1B
    const privateSubnet1BProps: crpm.Writeable<ec2.CfnSubnetProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-private-1b/props.yaml`
    );
    ...
    // Public Subnet 1A
    const publicSubnet1AProps: crpm.Writeable<ec2.CfnSubnetProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-public-1a/props.yaml`
    );
    ...
    // Public Subnet 1B
    const publicSubnet1BProps: crpm.Writeable<ec2.CfnSubnetProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-public-1b/props.yaml`
    );
    ...
    // NAT IP
    const natIpProps: crpm.Writeable<ec2.CfnEIPProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/eip-nat/props.yaml`
    );
    const natIp = new ec2.CfnEIP(this, "NATIP", natIpProps);
    
    // NAT Gateway
    const ngProps: crpm.Writeable<ec2.CfnNatGatewayProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/nat-gateway/props.yaml`
    );
    ...
    const privateSubnet1ARouteTableProps: crpm.Writeable<ec2.CfnRouteTableProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-table-private-1a/props.yaml`
    );
    ...
    const privateSubnet1ARouteProps: crpm.Writeable<ec2.CfnRouteProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-private-1a/props.yaml`
    );
    ...
    const privateSubnet1ARouteTableAssociationProps: crpm.Writeable<ec2.CfnSubnetRouteTableAssociationProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-route-table-association-private-1a/props.yaml`
    );
    ...
    const privateSubnet1BRouteTableProps: crpm.Writeable<ec2.CfnRouteTableProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-table-private-1b/props.yaml`
    );
    ...
    const privateSubnet1BRouteProps: crpm.Writeable<ec2.CfnRouteProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-private-1b/props.yaml`
    );
    ...
    const privateSubnet1BRouteTableAssociationProps: crpm.Writeable<ec2.CfnSubnetRouteTableAssociationProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-route-table-association-private-1b/props.yaml`
    );
    ...
    const publicSubnetRouteTableProps: crpm.Writeable<ec2.CfnRouteTableProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-table-public/props.yaml`
    );
    ...
    // Public Subnet Route
    const publicSubnetRouteProps: crpm.Writeable<ec2.CfnRouteProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/route-public/props.yaml`
    );
    ...
    const publicSubnet1ARouteTableAssociationProps: crpm.Writeable<ec2.CfnSubnetRouteTableAssociationProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-route-table-association-public-1a/props.yaml`
    );
    ...
    const publicSubnet1BRouteTableAssociationProps: crpm.Writeable<ec2.CfnSubnetRouteTableAssociationProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/subnet-route-table-association-public-1b/props.yaml`
    );
    ...
    const clusterSharedNodeSecurityGroupProps: crpm.Writeable<ec2.CfnSecurityGroupProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/security-group-cluster-shared-node/props.yaml`
    );
    ...
    const controlPlaneSecurityGroupProps: crpm.Writeable<ec2.CfnSecurityGroupProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/security-group-control-plane/props.yaml`
    );
    ...
    const clusterToNodeSGIngressProps: crpm.Writeable<ec2.CfnSecurityGroupIngressProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/security-group-ingress-cluster-to-node/props.yaml`
    );
    ...
    const nodeToNodeSGIngressProps: crpm.Writeable<ec2.CfnSecurityGroupIngressProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/security-group-ingress-node-to-node/props.yaml`
    );
    ...
    const nodeToClusterSGIngressProps: crpm.Writeable<ec2.CfnSecurityGroupIngressProps> = crpm.loadProps(
      `${BASE_DIR}/compute/ec2/security-group-ingress-node-to-cluster/props.yaml`
    );
    ...
    // Service Role
    const serviceRoleProps: crpm.Writeable<iam.CfnRoleProps> = crpm.loadProps(
      `${BASE_DIR}/security-identity-compliance/iam/role-service/props.yaml`
    );
    const serviceRole = new iam.CfnRole(this, "ServiceRole", serviceRoleProps);
    
    // CloudWatch Metrics Policy
    const cloudWatchMetricsPolicyProps: crpm.Writeable<iam.CfnPolicyProps> = crpm.loadProps(
      `${BASE_DIR}/security-identity-compliance/iam/policy-cloudwatch-metrics/props.yaml`
    );
    ...
    // NLB Policy
    const nlbPolicyProps: crpm.Writeable<iam.CfnPolicyProps> = crpm.loadProps(
      `${BASE_DIR}/security-identity-compliance/iam/policy-nlb/props.yaml`
    );
    ...
    // Control Plane
    const props: crpm.Writeable<eks.CfnClusterProps> = crpm.loadProps(`${__dirname}/props.yaml`);
    ...
    props.roleArn = serviceRole.attrArn;
    props.name = cdk.Aws.STACK_NAME;
    const cluster = new eks.CfnCluster(this, "ControlPlane", props);
    
    // Fargate Pod Execution Role
    const fargatePodExecutionRoleProps: crpm.Writeable<iam.CfnRoleProps> = crpm.loadProps(
      `${BASE_DIR}/security-identity-compliance/iam/role-fargate-pod-execution/props.yaml`
    );
